...
NCPUS="0"                       # number of CPUs on your machine minus one
IF="enp0s25"                   # network interface to test
DST_IP="192.168.100.2"             # destination IP address
SRC_MAC="68:f7:28:1f:d9:5f"     # source MAC address
DST_MAC="68:f7:28:1f:d9:9d"     # destination MAC address
PKT_SIZE="512"                   # packet size
PKT_COUNT="10000000"            # number of packets to send (0 means an infinite number)
